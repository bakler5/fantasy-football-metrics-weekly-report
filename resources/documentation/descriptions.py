...
team_z_score_rankings = (
    ...
    "scores for the current week. See <a href=\"https://en.wikipedia.org/wiki/Standard_score\" color=blue>Standard "
    "Score</a>. This metric shows which teams over-performed or underperformed compared to how those teams usually do."
)
...
team_coaching_efficiency_rankings = (
    ...
    "lost.<br/>&nbsp;&nbsp;&nbsp;&nbsp;If tie-breaks are turned on, the team with the most starting players that "
...
team_luck_rankings = (
    ...
    "<i>luck = (losses + ties) / (number of teams excluding that team) * 100</i>"
    "</div>"
    "<br/>"
    ...
    "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;"
    "<div style=\"text-align:center;\">"
    "<i>luck = 0 - (wins + ties) / (number of teams excluding that team) * 100</i>"
    "</div>"
    "<br/>"
    "&nbsp;&nbsp;&nbsp;&nbsp;"
...
beef_rankings = (
    "The Beef ranking is a \"just-for-fun\" metric with a made-up unit of measurement, the \"<b>TABBU</b>\", which "
    "stands for \"<b>T</b>rimmed <b>A</b>nd <b>B</b>oneless <b>B</b>eef <b>U</b>nit(s)\". The TABBU was derived from "
    "the amount of trimmed and boneless beef is produced by one beef cow, based on academic research done for the beef "
    "industry found "
    "<a href=\"https://extension.tennessee.edu/publications/Documents/PB1822.pdf\" color=blue>here</a>, and is set as "
    "equivalent to 500 lbs. The app pulls player weight data from the Sleeper API, an example of which can be found "
    "<a href=\"https://api.sleeper.app/v1/players/nfl\" color=blue><u>here</u></a>, and uses the total weight of each "
...
high_roller_rankings = (
    ...
    "punishable by the NFL) from <a href=\"https://www.spotrac.com/nfl/fines\" color=blue><u>Spotrac</u></a>, and then "
